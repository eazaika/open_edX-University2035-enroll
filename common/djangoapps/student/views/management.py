...
from stsos_widget.models import stsos_add_enrollment, stsos_unenroll
...
def change_enrollment(request, check_access=True):
    ...
    if action == "enroll":
        ...
        try:
            University2035Block.enroll(user, course_id)
        except Exception:
            return HttpResponseBadRequest(_("Error: fault when tried to enroll on University 2035"))
        ...
        stsos_add_enrollment(user, course_id)
        ...
        try:
            University2035Block.unenroll(user, course_id)
        except Exception:
            return HttpResponseBadRequest(_("Error: fault when tried to unenroll on University 2035"))

        CourseEnrollment.unenroll(user, course_id)

        stsos_unenroll(user, course_id)
